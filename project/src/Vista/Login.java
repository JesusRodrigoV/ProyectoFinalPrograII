...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        gbl_contentPane.rowHeights = new int[]{166, 24, 24, 30, 10, 0};
...
*/
        ...
        btnNewButton.setBorder(new MatteBorder(1, 0, 0, 0, verdeBoton));
        ...
        btnNewButton_1.setBorder(new MatteBorder(1, 0, 0, 0, rojo));
